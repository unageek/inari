...
fn fi_lib_unary_functions_gmp() {
    assert_eq!(n2i(hexf64!("-0x1.16cc0df1540f5p+112"), hexf64!("-0x1.b3e4076622f04p-232")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.210215cd4421cp-219"), hexf64!("-0x1.5109a14ed8284p-507")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.07172058aec0ap+273"), hexf64!("-0x1.5d74cfda6b292p-200")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.0753c8c437b89p-415"), hexf64!("-0x1.ff335468d1a39p-455")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp [-0X6.FF424CB26239CP+292, -0X2.89F6682121BA8P+252] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.101ddfbee0029p+335"), hexf64!("-0x1.c4e85e50a626dp+0")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.5d21a2bd88eccp-3")));
    assert_eq!(n2i(hexf64!("-0x1.b2a0d51958e97p+238"), hexf64!("-0x1.3c3ca0dc2427fp-438")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.39815cb53f3f4p+174"), hexf64!("-0x1.eb095183538c8p-344")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.3f6c4aa3b2589p-287"), hexf64!("-0x1.0e3b84422f7d2p-753")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.b9e7371bad173p-73"), hexf64!("-0x1.0040b8b626af6p-561")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp [-0X1.582D3AFB2C63DP+312, -0X5.08DC843E57ED4P+180] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.2bca5b74dff5dp+258"), hexf64!("-0x1.72f8af508ec0bp-46")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.fffffffffff47p-1")));
    assert_eq!(n2i(hexf64!("-0x1.1fba2d1252d2bp+656"), hexf64!("-0x1.25bd204ae48dap+9")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.5d7a2f6655dfcp-848")));
    //exp [-0X3.2FD3FDE325402P+688, -0X2.738623C238270P+48] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.44f2134e1901ep+8"), hexf64!("-0x1.2c0ed6cd7f36ep-171")).exp(), n2i(hexf64!("0x1.26980ecc80364p-469"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.4a94f199f955dp+989"), hexf64!("-0x1.c64e43e18bd27p-542")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.58391fd92c387p-148"), hexf64!("-0x1.0304909a95c65p-438")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.7f5b89f707c28p+351"), hexf64!("-0x1.e27c711642cbep-509")).exp(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    //exp [-0XD.F2552B8F60978P+236, -0X7.FBDBC320979A4P+188] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.10d04d9c356e0p-237"), hexf64!("-0x1.3faa34e8fb406p-314")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("0x1.0000000000000p+0"), hexf64!("0x1.0000000000000p+1")).exp(), n2i(hexf64!("0x1.5bf0a8b145769p+1"), hexf64!("0x1.d8e64b8d4ddaep+2")));
    assert_eq!(n2i(hexf64!("-0x1.0000000000000p+0"), hexf64!("0x1.0000000000000p+1")).exp(), n2i(hexf64!("0x1.78b56362cef37p-2"), hexf64!("0x1.d8e64b8d4ddaep+2")));
    assert_eq!(n2i(hexf64!("-0x1.4000000000000p+2"), hexf64!("-0x1.8000000000000p+1")).exp(), n2i(hexf64!("0x1.b993fe00d5376p-8"), hexf64!("0x1.97db0ccceb0afp-5")));
    assert_eq!(n2i(hexf64!("-0x1.0000000000000p+1"), hexf64!("0x1.3333333333333p-1")).exp(), n2i(hexf64!("0x1.152aaa3bf81cbp-3"), hexf64!("0x1.d27660b11a9f0p+0")));
    assert_eq!(n2i(hexf64!("0x0.0000000000001p-1022"), hexf64!("0x0.0000000111111p-1022")).exp(), n2i(hexf64!("0x1.0000000000000p+0"), hexf64!("0x1.0000000000001p+0")));
    assert_eq!(n2i(hexf64!("0x0.0000000001111p-1022"), hexf64!("0x1.0000000000000p+0")).exp(), n2i(hexf64!("0x1.0000000000000p+0"), hexf64!("0x1.5bf0a8b14576ap+1")));
    assert_eq!(n2i(hexf64!("-0x0.0000000011111p-1022"), hexf64!("0x0.0000000011111p-1022")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000001p+0")));
    assert_eq!(n2i(hexf64!("-0x0.0000000000111p-1022"), hexf64!("0x1.fff0000000000p+0")).exp(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.d8c8be15033edp+2")));
    assert_eq!(n2i(hexf64!("-0x1.ffff000000000p+0"), hexf64!("-0x0.0000002222222p-1022")).exp(), n2i(hexf64!("0x1.152bbf672cee3p-3"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.fffffff000000p+0"), hexf64!("0x0.0000233445555p-1022")).exp(), n2i(hexf64!("0x1.152aaa4d4ac75p-3"), hexf64!("0x1.0000000000001p+0")));
    assert_eq!(n2i(hexf64!("-0x1.16cc0df1540f5p+112"), hexf64!("-0x1.b3e4076622f04p-232")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.210215cd4421cp-219"), hexf64!("-0x1.5109a14ed8284p-507")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.07172058aec0ap+273"), hexf64!("-0x1.5d74cfda6b292p-200")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.0753c8c437b89p-415"), hexf64!("-0x1.ff335468d1a39p-455")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp2 [-0X6.FF424CB26239CP+292, -0X2.89F6682121BA8P+252] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.101ddfbee0029p+335"), hexf64!("-0x1.c4e85e50a626dp+0")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.2c6b1be11c121p-2")));
    assert_eq!(n2i(hexf64!("-0x1.b2a0d51958e97p+238"), hexf64!("-0x1.3c3ca0dc2427fp-438")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.39815cb53f3f4p+174"), hexf64!("-0x1.eb095183538c8p-344")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.3f6c4aa3b2589p-287"), hexf64!("-0x1.0e3b84422f7d2p-753")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.b9e7371bad173p-73"), hexf64!("-0x1.0040b8b626af6p-561")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp2 [-0X1.582D3AFB2C63DP+312, -0X5.08DC843E57ED4P+180] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.2bca5b74dff5dp+258"), hexf64!("-0x1.72f8af508ec0bp-46")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.fffffffffff80p-1")));
    assert_eq!(n2i(hexf64!("-0x1.1fba2d1252d2bp+656"), hexf64!("-0x1.25bd204ae48dap+9")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.6fb78c613e5ecp-588")));
    //exp2 [-0X3.2FD3FDE325402P+688, -0X2.738623C238270P+48] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.44f2134e1901ep+8"), hexf64!("-0x1.2c0ed6cd7f36ep-171")).exp2(), n2i(hexf64!("0x1.09d60717370a1p-325"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.4a94f199f955dp+989"), hexf64!("-0x1.c64e43e18bd27p-542")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.58391fd92c387p-148"), hexf64!("-0x1.0304909a95c65p-438")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.7f5b89f707c28p+351"), hexf64!("-0x1.e27c711642cbep-509")).exp2(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    //exp2 [-0XD.F2552B8F60978P+236, -0X7.FBDBC320979A4P+188] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.10d04d9c356e0p-237"), hexf64!("-0x1.3faa34e8fb406p-314")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("0x1.0000000000000p+0"), hexf64!("0x1.0000000000000p+1")).exp2(), n2i(hexf64!("0x1.0000000000000p+1"), hexf64!("0x1.0000000000000p+2")));
    assert_eq!(n2i(hexf64!("-0x1.0000000000000p+0"), hexf64!("0x1.0000000000000p+1")).exp2(), n2i(hexf64!("0x1.0000000000000p-1"), hexf64!("0x1.0000000000000p+2")));
    assert_eq!(n2i(hexf64!("-0x1.4000000000000p+2"), hexf64!("-0x1.8000000000000p+1")).exp2(), n2i(hexf64!("0x1.0000000000000p-5"), hexf64!("0x1.0000000000000p-3")));
    assert_eq!(n2i(hexf64!("-0x1.0000000000000p+1"), hexf64!("0x1.3333333333333p-1")).exp2(), n2i(hexf64!("0x1.0000000000000p-2"), hexf64!("0x1.8406003b2ae5dp+0")));
    assert_eq!(n2i(hexf64!("0x0.0000000000111p-1022"), hexf64!("0x0.0000001123344p-1022")).exp2(), n2i(hexf64!("0x1.0000000000000p+0"), hexf64!("0x1.0000000000001p+0")));
    assert_eq!(n2i(hexf64!("-0x0.0001234542222p-1022"), hexf64!("0x0.0000012344555p-1022")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000001p+0")));
    assert_eq!(n2i(hexf64!("0x0.0000342223444p-1022"), hexf64!("0x1.000003443aaaap+0")).exp2(), n2i(hexf64!("0x1.0000000000000p+0"), hexf64!("0x1.00000243a1430p+1")));
    assert_eq!(n2i(hexf64!("-0x0.0003455543322p-1022"), hexf64!("0x0.0000012345433p-1022")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000001p+0")));
    assert_eq!(n2i(hexf64!("-0x0.0000012345678p-1022"), hexf64!("0x1.ffffff0999999p+0")).exp2(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.fffffeaa6ac58p+1")));
    assert_eq!(n2i(hexf64!("-0x1.fffffffffffffp+0"), hexf64!("0x0.0000453224455p-1022")).exp2(), n2i(hexf64!("0x1.0000000000000p-2"), hexf64!("0x1.0000000000001p+0")));
    assert_eq!(n2i(hexf64!("-0x1.422bde014cc37p+113"), hexf64!("-0x1.7a77bfccf5a9ep-232")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.81702ec6f2dccp-218"), hexf64!("-0x1.e2f6187ddb464p-507")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.4d84c8cdfcecfp+273"), hexf64!("-0x1.c41fe837a300bp-201")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.1503444763fc5p-416"), hexf64!("-0x1.03aefcc5923c6p-455")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp10 [-0X2.7C064F6929234P+292, -0X1.5444E676976F1P+252] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.3b2f21561c420p+334"), hexf64!("-0x1.3a01905e36f84p+0")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.e62ff0aaac51ep-5")));
    assert_eq!(n2i(hexf64!("-0x1.ccbb6adfd8294p+238"), hexf64!("-0x1.202722624e322p-439")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.9498f3e13bce2p+174"), hexf64!("-0x1.63a15e999eb64p-344")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.4171976a1ca54p-288"), hexf64!("-0x1.a507d1c29c01dp-754")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.1a6ec74d2e55cp-74"), hexf64!("-0x1.de287d1d68c1bp-562")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp10 [-0X1.F0D19ADCB5D74P+312, -0X1.BA04D452BBB35P+180] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.70236daaa01bep+257"), hexf64!("-0x1.355e0aabcd959p-47")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.fffffffffff4ep-1")));
    assert_eq!(n2i(hexf64!("-0x1.c678939eb70f2p+655"), hexf64!("-0x1.052f533db3da1p+11")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x0.0000000000001p-1022")));
    //exp10 [-0X2.A69A969772FDEP+688, -0X3.436DFE8F08194P+48] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.7aaa15ebbd3f2p+8"), hexf64!("-0x1.8f96439899147p-170")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.47c9025e2020fp+989"), hexf64!("-0x1.ab3e906363e4bp-542")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.5802285246ac3p-147"), hexf64!("-0x1.5dab859ab6365p-439")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.9e7ddbbe00f75p+352"), hexf64!("-0x1.8826528c34186p-509")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    //exp10 [-0XD.5E2045CEE9720P+236, -0X6.6978492A3064CP+188] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.5bd629b25aa23p-236"), hexf64!("-0x1.f7a98177b25f3p-314")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp10 [-0XB.A944253373080P+564, -0XD.05E9CCF66CF58P+424] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.d70ee09d32965p+169"), hexf64!("-0x1.9975f82891ddep-54")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.fffffffffffffp-1")));
    assert_eq!(n2i(hexf64!("-0x1.44f68aaa2b029p-65"), hexf64!("-0x1.4ad560048c7b2p-342")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.d68a6ba7e617fp+12"), hexf64!("-0x1.8dad9877389a2p-234")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.98ef0c6a8bd66p+132"), hexf64!("-0x1.eb0e1ab78f314p-480")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.c08152cc09416p+220"), hexf64!("-0x1.d33c64c4c7e99p-190")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.bdc3836934ae8p-138"), hexf64!("-0x1.7036c237d5b00p-672")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    //exp10 [-0XB.24D19E00C8460P+324, -0X1.D283CF8F05665P+252] = [0X0.0000000000000P+0, 0X0.0000000000000P+0];
    assert_eq!(n2i(hexf64!("-0x1.f9926ff4661c8p+651"), hexf64!("-0x1.d07742228e496p-323")).exp10(), n2i(hexf64!("0x0.0p+0"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("-0x1.7ddd664e50062p-118"), hexf64!("-0x1.8bca641025a83p-124")).exp10(), n2i(hexf64!("0x1.fffffffffffffp-1"), hexf64!("0x1.0000000000000p+0")));
    assert_eq!(n2i(hexf64!("0x1.89694dd6d675ep-261"), hexf64!("0x1.5ba589837c966p+95")).log(), n2i(hexf64!("-0x1.68f6a61420a9bp+7"), hexf64!("0x1.089eb6060fedcp+6")));
    assert_eq!(n2i(hexf64!("0x1.3109f10d8a44ap-515"), hexf64!("0x1.9981bc265797dp-222")).log(), n2i(hexf64!("-0x1.64cba844fc0eap+8"), hexf64!("-0x1.32d15b16ad3fcp+7")));
    assert_eq!(n2i(hexf64!("0x1.21fe595436609p-237"), hexf64!("0x1.95f14b9ba7449p+236")).log(), n2i(hexf64!("-0x1.484d6a28b4894p+7"), hexf64!("0x1.481668de8a843p+7")));
    assert_eq!(n2i(hexf64!("0x1.1c55b51bf7d27p-489"), hexf64!("0x1.b3e59df05d8a3p-451")).log(), n2i(hexf64!("-0x1.52d81024e4c23p+8"), hexf64!("-0x1.3813c01acd25cp+8")));
    assert_eq!(n2i(hexf64!("0x1.394270bbcba7ep+196"), hexf64!("0x1.092ede17e8b48p+227")).log(), n2i(hexf64!("0x1.101e0e2f43b88p+7"), hexf64!("0x1.3ac261e03f16fp+7")));
    assert_eq!(n2i(hexf64!("0x1.a800284a0e694p-42"), hexf64!("0x1.c36e2ca1ca0adp+277")).log(), n2i(hexf64!("-0x1.c9b8d4127e3dap+4"), hexf64!("0x1.812355a240e0bp+7")));
    assert_eq!(n2i(hexf64!("0x1.3c84e4f9c80cep-476"), hexf64!("0x1.23d287387686bp+199")).log(), n2i(hexf64!("-0x1.49b9d16b7e46ap+8"), hexf64!("0x1.14226f7bcab9fp+7")));
    assert_eq!(n2i(hexf64!("0x1.083a5b6db26a9p-373"), hexf64!("0x1.76e7a53c8c81ap+141")).log(), n2i(hexf64!("-0x1.028323b4d95b4p+8"), hexf64!("0x1.8876036464eaep+6")));
    assert_eq!(n2i(hexf64!("0x1.2c18feebcaeaep-768"), hexf64!("0x1.c369e759df5e3p-328")).log(), n2i(hexf64!("-0x1.0a16cc1e8ad14p+9"), hexf64!("-0x1.c591f47f12d4ap+7")));
    assert_eq!(n2i(hexf64!("0x1.3653a458674fcp-578"), hexf64!("0x1.4fb657b5aa89fp-131")).log(), n2i(hexf64!("-0x1.907255d3994fep+8"), hexf64!("-0x1.6a1ff3d7ef600p+6")));
    assert_eq!(n2i(hexf64!("0x1.4e68960e85562p+117"), hexf64!("0x1.dfbf07296e0d5p+277")).log(), n2i(hexf64!("0x1.45762d0438297p+6"), hexf64!("0x1.81427b8a6d9abp+7")));
    assert_eq!(n2i(hexf64!("0x1.9b6f2e2aaca77p-99"), hexf64!("0x1.d0460177b1553p+204")).log(), n2i(hexf64!("-0x1.1096a11d38e60p+6"), hexf64!("0x1.1bfea0dfc1b3fp+7")));
    assert_eq!(n2i(hexf64!("0x1.2f500c5cdbdeap+6"), hexf64!("0x1.f4217679238f6p+595")).log(), n2i(hexf64!("0x1.1505a690a5d52p+2"), hexf64!("0x1.9d179ea5204d0p+8")));
    assert_eq!(n2i(hexf64!("0x1.4712c6d9e227cp+21"), hexf64!("0x1.8d276f38cd260p+629")).log(), n2i(hexf64!("0x1.d9a297d7c59adp+3"), hexf64!("0x1.b46dc0d02b874p+8")));
    assert_eq!(n2i(hexf64!("0x1.19ca879c7c187p-175"), hexf64!("0x1.6f80e21866c06p-22")).log(), n2i(hexf64!("-0x1.e4d1aeae0e6d6p+6"), hexf64!("-0x1.dc67e59267732p+3")));
    assert_eq!(n2i(hexf64!("0x1.92781ef99ab46p-559"), hexf64!("0x1.cce4ab046843dp+923")).log(), n2i(hexf64!("-0x1.83044f26aaa2bp+8"), hexf64!("0x1.402e716e4881bp+9")));
    assert_eq!(n2i(hexf64!("0x1.6ab931cee2fd4p-467"), hexf64!("0x1.95cf42aa171cdp-160")).log(), n2i(hexf64!("-0x1.4359ecd75cb6cp+8"), hexf64!("-0x1.b9c5786e838d7p+6")));
    assert_eq!(n2i(hexf64!("0x1.1c1680a0c0b6cp-530"), hexf64!("0x1.72b9a0e0a4b86p+325")).log(), n2i(hexf64!("-0x1.6f438ee9f6020p+8"), hexf64!("0x1.c34946a47e4cbp+7")));
    assert_eq!(n2i(hexf64!("0x1.36e874875bcc2p+146"), hexf64!("0x1.b33cc462bc32dp+197")).log(), n2i(hexf64!("0x1.9593426b47485p+6"), hexf64!("0x1.122952a63fa23p+7")));
    assert_eq!(n2i(hexf64!("0x1.27e9687937dd0p-326"), hexf64!("0x1.11b85141b78f6p-240")).log(), n2i(hexf64!("-0x1.c3a466d4b7c35p+7"), hexf64!("-0x1.4c93a886c545ep+7")));
    assert_eq!(n2i(hexf64!("0x1.419bd3b802b61p+363"), hexf64!("0x1.f33b09f0c558bp+527")).log(), n2i(hexf64!("0x1.f7ae611dae7fep+7"), hexf64!("0x1.6df4da39dc5ddp+8")));
    assert_eq!(n2i(hexf64!("0x1.a211040e355aep-106"), hexf64!("0x1.9eb2e04c9c099p+137")).log(), n2i(hexf64!("-0x1.23eebbc45a709p+6"), hexf64!("0x1.7dc62efc338bep+6")));
    assert_eq!(n2i(hexf64!("0x1.c5d872ac1544dp-354"), hexf64!("0x1.92efd09488689p-76")).log(), n2i(hexf64!("-0x1.e99a612947697p+7"), hexf64!("-0x1.a1cdfeb8cdd74p+5")));
    assert_eq!(n2i(hexf64!("0x1.88217909d04f2p-250"), hexf64!("0x1.719ba76049d42p-33")).log(), n2i(hexf64!("-0x1.59b8835dce863p+7"), hexf64!("-0x1.681aff89e9c89p+4")));
    assert_eq!(n2i(hexf64!("0x1.7ebe381f4672fp-501"), hexf64!("0x1.2493763542c73p+74")).log(), n2i(hexf64!("-0x1.5add53379ef4dp+8"), hexf64!("0x1.9b695890a8454p+5")));
    assert_eq!(n2i(hexf64!("0x1.778fc6fd65a71p-213"), hexf64!("0x1.cfe27bb53debbp+192")).log(), n2i(hexf64!("-0x1.2683a32d5a5abp+7"), hexf64!("0x1.0b5b80d3ec315p+7")));
    assert_eq!(n2i(hexf64!("0x1.e139dd116f868p-688"), hexf64!("0x1.a4a8a68dad1fap-145")).log(), n2i(hexf64!("-0x1.dc410cbc8e1c8p+8"), hexf64!("-0x1.9009ede74baaap+6")));
    assert_eq!(n2i(hexf64!("0x1.7064732544856p+193"), hexf64!("0x1.3544c696554d2p+261")).log(), n2i(hexf64!("0x1.0c486291e8c41p+7"), hexf64!("0x1.6a336dca89f13p+7")));
    assert_eq!(n2i(hexf64!("0x1.671190bb5e2f2p-338"), hexf64!("0x1.18c6f488cbc30p+590")).log(), n2i(hexf64!("-0x1.d3e40ce850a83p+7"), hexf64!("0x1.990c99b6124fep+8")));
    assert_eq!(n2i(hexf64!("0x1.f80bd5021bfd1p-177"), hexf64!("0x1.40b109f7dabe9p-149")).log(), n2i(hexf64!("-0x1.e809ca35f4de4p+6"), hexf64!("-0x1.9c36ea24e85b8p+6")));
    assert_eq!(n2i(hexf64!("0x1.89694dd6d675ep-261"), hexf64!("0x1.5ba589837c966p+95")).log2(), n2i(hexf64!("-0x1.04614e93ea794p+8"), hexf64!("0x1.7dc412c120139p+6")));
    assert_eq!(n2i(hexf64!("0x1.3109f10d8a44ap-515"), hexf64!("0x1.9981bc265797dp-222")).log2(), n2i(hexf64!("-0x1.015fa2a3e7ba5p+9"), hexf64!("-0x1.baa4fecd36f54p+7")));
    assert_eq!(n2i(hexf64!("0x1.21fe595436609p-237"), hexf64!("0x1.95f14b9ba7449p+236")).log2(), n2i(hexf64!("-0x1.d9a3e7294584dp+7"), hexf64!("0x1.d9548c27863fap+7")));
    assert_eq!(n2i(hexf64!("0x1.1c55b51bf7d27p-489"), hexf64!("0x1.b3e59df05d8a3p-451")).log2(), n2i(hexf64!("-0x1.e8d93ac78e47cp+8"), hexf64!("-0x1.c23b6e9f9be73p+8")));
    assert_eq!(n2i(hexf64!("0x1.394270bbcba7ep+196"), hexf64!("0x1.092ede17e8b48p+227")).log2(), n2i(hexf64!("0x1.88951a1490120p+7"), hexf64!("0x1.c61a0857a65c1p+7")));
    assert_eq!(n2i(hexf64!("0x1.a800284a0e694p-42"), hexf64!("0x1.c36e2ca1ca0adp+277")).log2(), n2i(hexf64!("-0x1.4a2d36f1ab279p+5"), hexf64!("0x1.15d18004da527p+8")));
    assert_eq!(n2i(hexf64!("0x1.3c84e4f9c80cep-476"), hexf64!("0x1.23d287387686bp+199")).log2(), n2i(hexf64!("-0x1.dbb1a03ad9911p+8"), hexf64!("0x1.8e60bd9f1cebbp+7")));
    assert_eq!(n2i(hexf64!("0x1.083a5b6db26a9p-373"), hexf64!("0x1.76e7a53c8c81ap+141")).log2(), n2i(hexf64!("-0x1.74f450fb5f194p+8"), hexf64!("0x1.1b19cb810411ap+7")));
    assert_eq!(n2i(hexf64!("0x1.2c18feebcaeaep-768"), hexf64!("0x1.c369e759df5e3p-328")).log2(), n2i(hexf64!("-0x1.7fe2a6af7cf2dp+9"), hexf64!("-0x1.472e83799ccfap+8")));
    assert_eq!(n2i(hexf64!("0x1.3653a458674fcp-578"), hexf64!("0x1.4fb657b5aa89fp-131")).log2(), n2i(hexf64!("-0x1.20dc762820db4p+9"), hexf64!("-0x1.0537c42b00082p+7")));
    assert_eq!(n2i(hexf64!("0x1.4e68960e85562p+117"), hexf64!("0x1.dfbf07296e0d5p+277")).log2(), n2i(hexf64!("0x1.d58ab8177d1a6p+6"), hexf64!("0x1.15e7f7fa196aap+8")));
    assert_eq!(n2i(hexf64!("0x1.9b6f2e2aaca77p-99"), hexf64!("0x1.d0460177b1553p+204")).log2(), n2i(hexf64!("-0x1.89430da57f3c8p+6"), hexf64!("0x1.99b7b8b271aacp+7")));
    assert_eq!(n2i(hexf64!("0x1.2f500c5cdbdeap+6"), hexf64!("0x1.f4217679238f6p+595")).log2(), n2i(hexf64!("0x1.8fa88afb44648p+2"), hexf64!("0x1.29fbab2d37d26p+9")));
    assert_eq!(n2i(hexf64!("0x1.4712c6d9e227cp+21"), hexf64!("0x1.8d276f38cd260p+629")).log2(), n2i(hexf64!("0x1.55a7d090e9bc4p+4"), hexf64!("0x1.3ad11853778a4p+9")));
    assert_eq!(n2i(hexf64!("0x1.19ca879c7c187p-175"), hexf64!("0x1.6f80e21866c06p-22")).log2(), n2i(hexf64!("-0x1.5db918d5c1340p+7"), hexf64!("-0x1.57a778189781ep+4")));
    assert_eq!(n2i(hexf64!("0x1.92781ef99ab46p-559"), hexf64!("0x1.cce4ab046843dp+923")).log2(), n2i(hexf64!("-0x1.172c7330df7a9p+9"), hexf64!("0x1.cdec94ba0c393p+9")));
    assert_eq!(n2i(hexf64!("0x1.6ab931cee2fd4p-467"), hexf64!("0x1.95cf42aa171cdp-160")).log2(), n2i(hexf64!("-0x1.d27f4d5811ec0p+8"), hexf64!("-0x1.3eabb1c94a3f1p+7")));
    assert_eq!(n2i(hexf64!("0x1.1c1680a0c0b6cp-530"), hexf64!("0x1.72b9a0e0a4b86p+325")).log2(), n2i(hexf64!("-0x1.08ecc674f80f4p+9"), hexf64!("0x1.4588c1b9f05fcp+8")));
    assert_eq!(n2i(hexf64!("0x1.36e874875bcc2p+146"), hexf64!("0x1.b33cc462bc32dp+197")).log2(), n2i(hexf64!("0x1.248f8941ad448p+7"), hexf64!("0x1.8b88046862dbcp+7")));
    assert_eq!(n2i(hexf64!("0x1.27e9687937dd0p-326"), hexf64!("0x1.11b85141b78f6p-240")).log2(), n2i(hexf64!("-0x1.45ca7d7508d73p+8"), hexf64!("-0x1.dfce901514d4ep+7")));
    assert_eq!(n2i(hexf64!("0x1.419bd3b802b61p+363"), hexf64!("0x1.f33b09f0c558bp+527")).log2(), n2i(hexf64!("0x1.6b54440063a2fp+8"), hexf64!("0x1.07fb56050ef84p+9")));
    assert_eq!(n2i(hexf64!("0x1.a211040e355aep-106"), hexf64!("0x1.9eb2e04c9c099p+137")).log2(), n2i(hexf64!("-0x1.a52b6dea01d8cp+6"), hexf64!("0x1.13644f9ad36f6p+7")));
    assert_eq!(n2i(hexf64!("0x1.c5d872ac1544dp-354"), hexf64!("0x1.92efd09488689p-76")).log2(), n2i(hexf64!("-0x1.612c877fdefc9p+8"), hexf64!("-0x1.2d61e26df4aaep+6")));
    assert_eq!(n2i(hexf64!("0x1.88217909d04f2p-250"), hexf64!("0x1.719ba76049d42p-33")).log2(), n2i(hexf64!("-0x1.f2c505b013dbcp+7"), hexf64!("-0x1.03c2dcd138608p+5")));
    assert_eq!(n2i(hexf64!("0x1.7ebe381f4672fp-501"), hexf64!("0x1.2493763542c73p+74")).log2(), n2i(hexf64!("-0x1.f46b75e4932f4p+8"), hexf64!("0x1.28c54ab0884a6p+6")));
    assert_eq!(n2i(hexf64!("0x1.778fc6fd65a71p-213"), hexf64!("0x1.cfe27bb53debbp+192")).log2(), n2i(hexf64!("-0x1.a8e4e985c1653p+7"), hexf64!("0x1.81b71a4a4e095p+7")));
    assert_eq!(n2i(hexf64!("0x1.e139dd116f868p-688"), hexf64!("0x1.a4a8a68dad1fap-145")).log2(), n2i(hexf64!("-0x1.578b7269eb094p+9"), hexf64!("-0x1.20912609254f4p+7")));
    assert_eq!(n2i(hexf64!("0x1.7064732544856p+193"), hexf64!("0x1.3544c696554d2p+261")).log2(), n2i(hexf64!("0x1.830cd9d4b6081p+7"), hexf64!("0x1.0545d0c4da7bap+8")));
    assert_eq!(n2i(hexf64!("0x1.671190bb5e2f2p-338"), hexf64!("0x1.18c6f488cbc30p+590")).log2(), n2i(hexf64!("-0x1.51830ad8b30fcp+8"), hexf64!("0x1.27110f60eda9fp+9")));
    assert_eq!(n2i(hexf64!("0x1.f80bd5021bfd1p-177"), hexf64!("0x1.40b109f7dabe9p-149")).log2(), n2i(hexf64!("-0x1.600b90a02a915p+7"), hexf64!("-0x1.2959940544905p+7")));
    assert_eq!(n2i(hexf64!("0x1.89694dd6d675ep-261"), hexf64!("0x1.5ba589837c966p+95")).log10(), n2i(hexf64!("-0x1.3987653132356p+6"), hexf64!("0x1.cbb1247192ae0p+4")));
    assert_eq!(n2i(hexf64!("0x1.3109f10d8a44ap-515"), hexf64!("0x1.9981bc265797dp-222")).log10(), n2i(hexf64!("-0x1.35e89e485066bp+7"), hexf64!("-0x1.0a7fa1147e789p+6")));
    assert_eq!(n2i(hexf64!("0x1.21fe595436609p-237"), hexf64!("0x1.95f14b9ba7449p+236")).log10(), n2i(hexf64!("-0x1.1d28eb6e5c712p+6"), hexf64!("0x1.1cf9249409319p+6")));
    assert_eq!(n2i(hexf64!("0x1.1c55b51bf7d27p-489"), hexf64!("0x1.b3e59df05d8a3p-451")).log10(), n2i(hexf64!("-0x1.2650ef9402c17p+7"), hexf64!("-0x1.0f1117bb79cbap+7")));
    assert_eq!(n2i(hexf64!("0x1.394270bbcba7ep+196"), hexf64!("0x1.092ede17e8b48p+227")).log10(), n2i(hexf64!("0x1.d8b7629283ef9p+5"), hexf64!("0x1.11657e5d5225ap+6")));
    assert_eq!(n2i(hexf64!("0x1.a800284a0e694p-42"), hexf64!("0x1.c36e2ca1ca0adp+277")).log10(), n2i(hexf64!("-0x1.8d927ffdec9efp+3"), hexf64!("0x1.4e86d1c6887fdp+6")));
    assert_eq!(n2i(hexf64!("0x1.3c84e4f9c80cep-476"), hexf64!("0x1.23d287387686bp+199")).log10(), n2i(hexf64!("-0x1.1e656fb764201p+7"), hexf64!("0x1.dfb1dd3d1e32cp+5")));
    assert_eq!(n2i(hexf64!("0x1.083a5b6db26a9p-373"), hexf64!("0x1.76e7a53c8c81ap+141")).log10(), n2i(hexf64!("-0x1.c114f0bc18592p+6"), hexf64!("0x1.54e3250b4187ep+5")));
    assert_eq!(n2i(hexf64!("0x1.2c18feebcaeaep-768"), hexf64!("0x1.c369e759df5e3p-328")).log10(), n2i(hexf64!("-0x1.ce3e78a053b09p+7"), hexf64!("-0x1.89f74cc710dfcp+6")));
    assert_eq!(n2i(hexf64!("0x1.3653a458674fcp-578"), hexf64!("0x1.4fb657b5aa89fp-131")).log10(), n2i(hexf64!("-0x1.5bd2d1fb2b57cp+7"), hexf64!("-0x1.3a89a14b4233ap+5")));
    assert_eq!(n2i(hexf64!("0x1.4e68960e85562p+117"), hexf64!("0x1.dfbf07296e0d5p+277")).log10(), n2i(hexf64!("0x1.1ab13f7e80530p+5"), hexf64!("0x1.4ea1dfd2b563ap+6")));
    assert_eq!(n2i(hexf64!("0x1.9b6f2e2aaca77p-99"), hexf64!("0x1.d0460177b1553p+204")).log10(), n2i(hexf64!("-0x1.d988d7ebc5ae3p+4"), hexf64!("0x1.ed5966bf9312fp+5")));
    assert_eq!(n2i(hexf64!("0x1.2f500c5cdbdeap+6"), hexf64!("0x1.f4217679238f6p+595")).log10(), n2i(hexf64!("0x1.e13c93cf0c5d8p+0"), hexf64!("0x1.66ceb0959229ap+7")));
    assert_eq!(n2i(hexf64!("0x1.4712c6d9e227cp+21"), hexf64!("0x1.8d276f38cd260p+629")).log10(), n2i(hexf64!("0x1.9b64ed5359908p+2"), hexf64!("0x1.7b13c19524eb3p+7")));
    assert_eq!(n2i(hexf64!("0x1.19ca879c7c187p-175"), hexf64!("0x1.6f80e21866c06p-22")).log10(), n2i(hexf64!("-0x1.a51bc6556aa6dp+5"), hexf64!("-0x1.9dcd053621b05p+2")));
    assert_eq!(n2i(hexf64!("0x1.92781ef99ab46p-559"), hexf64!("0x1.cce4ab046843dp+923")).log10(), n2i(hexf64!("-0x1.502896b71ebbbp+7"), hexf64!("0x1.161b25dac86ecp+8")));
    assert_eq!(n2i(hexf64!("0x1.6ab931cee2fd4p-467"), hexf64!("0x1.95cf42aa171cdp-160")).log10(), n2i(hexf64!("-0x1.18dbfe038ed2ep+7"), hexf64!("-0x1.7fb7bd8445866p+5")));
    assert_eq!(n2i(hexf64!("0x1.1c1680a0c0b6cp-530"), hexf64!("0x1.72b9a0e0a4b86p+325")).log10(), n2i(hexf64!("-0x1.3f0059c673d08p+7"), hexf64!("0x1.87fb743ee235ep+6")));
    assert_eq!(n2i(hexf64!("0x1.36e874875bcc2p+146"), hexf64!("0x1.b33cc462bc32dp+197")).log10(), n2i(hexf64!("0x1.60473631f9972p+5"), hexf64!("0x1.dc4464c944baap+5")));
    assert_eq!(n2i(hexf64!("0x1.27e9687937dd0p-326"), hexf64!("0x1.11b85141b78f6p-240")).log10(), n2i(hexf64!("-0x1.884a9ada4493cp+6"), hexf64!("-0x1.20df5e1a324efp+6")));
    assert_eq!(n2i(hexf64!("0x1.419bd3b802b61p+363"), hexf64!("0x1.f33b09f0c558bp+527")).log10(), n2i(hexf64!("0x1.b57ded7c53752p+6"), hexf64!("0x1.3ddda1003d490p+7")));
    assert_eq!(n2i(hexf64!("0x1.a211040e355aep-106"), hexf64!("0x1.9eb2e04c9c099p+137")).log10(), n2i(hexf64!("-0x1.fb238786d64f9p+4"), hexf64!("0x1.4b9ad54cfa155p+5")));
    assert_eq!(n2i(hexf64!("0x1.c5d872ac1544dp-354"), hexf64!("0x1.92efd09488689p-76")).log10(), n2i(hexf64!("-0x1.a943888037fc5p+6"), hexf64!("-0x1.6ae688b7c8203p+4")));
    assert_eq!(n2i(hexf64!("0x1.88217909d04f2p-250"), hexf64!("0x1.719ba76049d42p-33")).log10(), n2i(hexf64!("-0x1.2c4a0b1a3f93ep+6"), hexf64!("-0x1.38c89bf73dc7cp+3")));
    assert_eq!(n2i(hexf64!("0x1.7ebe381f4672fp-501"), hexf64!("0x1.2493763542c73p+74")).log10(), n2i(hexf64!("-0x1.2d486066d5ad0p+7"), hexf64!("0x1.6558f570c1420p+4")));
    assert_eq!(n2i(hexf64!("0x1.778fc6fd65a71p-213"), hexf64!("0x1.cfe27bb53debbp+192")).log10(), n2i(hexf64!("-0x1.ff9fa31c27071p+5"), hexf64!("0x1.d0728b08ffbafp+5")));
    assert_eq!(n2i(hexf64!("0x1.e139dd116f868p-688"), hexf64!("0x1.a4a8a68dad1fap-145")).log10(), n2i(hexf64!("-0x1.9dab473cba90fp+7"), hexf64!("-0x1.5b782266f2506p+5")));
    assert_eq!(n2i(hexf64!("0x1.7064732544856p+193"), hexf64!("0x1.3544c696554d2p+261")).log10(), n2i(hexf64!("0x1.d20e0c87f4f3dp+5"), hexf64!("0x1.3a9a8c08793eep+6")));
    assert_eq!(n2i(hexf64!("0x1.671190bb5e2f2p-338"), hexf64!("0x1.18c6f488cbc30p+590")).log10(), n2i(hexf64!("-0x1.9667a13fbdc6fp+6"), hexf64!("0x1.634baef78abf3p+7")));
    assert_eq!(n2i(hexf64!("0x1.f80bd5021bfd1p-177"), hexf64!("0x1.40b109f7dabe9p-149")).log10(), n2i(hexf64!("-0x1.a7e795e085c20p+5"), hexf64!("-0x1.660b83700b3e9p+5")));
