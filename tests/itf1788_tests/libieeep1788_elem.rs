...
fn minimal_pown_test() {
    ...
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(0), n2i(1.0, 1.0));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(0), n2i(1.0, 1.0));
    ...
    assert_eq2!(n2i(-7451.145, -7451.145).powi(2), n2i(55519561.811025, 55519561.81102501));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(2), n2i(1.7976931348623157e+308, f64::INFINITY));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(2), n2i(1.7976931348623157e+308, f64::INFINITY));
    ...
    assert_eq2!(n2i(0.01, 2.33).powi(2), n2i(9.999999999999999e-05, 5.4289000000000005));
    ...
    assert_eq2!(n2i(-0.0, -0.0).powi(8), n2i(0.0, 0.0));
    assert_eq2!(n2i(13.1, 13.1).powi(8), n2i(867302034.6900622, 867302034.6900623));
    assert_eq2!(n2i(-7451.145, -7451.145).powi(8), n2i(9.501323805961965e+30, 9.501323805961966e+30));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(8), n2i(1.7976931348623157e+308, f64::INFINITY));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(8), n2i(1.7976931348623157e+308, f64::INFINITY));
    ...
    assert_eq2!(n2i(0.01, 2.33).powi(8), n2i(1.0000000000000001e-16, 868.6550888106664));
    assert_eq2!(n2i(-1.9, -0.33).powi(8), n2i(0.00014064086182410005, 169.83563040999996));
    ...
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(1), n2i(1.7976931348623157e+308, 1.7976931348623157e+308));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(1), n2i(-1.7976931348623157e+308, -1.7976931348623157e+308));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(1), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(1), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(1), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(1), n2i(f64::NEG_INFINITY, 0.0));
    ...
    assert_eq2!(n2i(-7451.145, -7451.145).powi(3), n2i(-413684305390.41, -413684305390.4099));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(3), n2i(1.7976931348623157e+308, f64::INFINITY));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(3), n2i(f64::NEG_INFINITY, -1.7976931348623157e+308));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(3), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(3), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(3), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(3), n2i(f64::NEG_INFINITY, 0.0));
    ...
    assert_eq2!(n2i(-1.9, -0.33).powi(3), n2i(-6.858999999999999, -0.035937000000000004));
    assert_eq2!(I::EMPTY.powi(7), I::EMPTY);
    assert_eq2!(I::ENTIRE.powi(7), I::ENTIRE);
    assert_eq2!(n2i(0.0, 0.0).powi(7), n2i(0.0, 0.0));
    assert_eq2!(n2i(-0.0, -0.0).powi(7), n2i(0.0, 0.0));
    assert_eq2!(n2i(13.1, 13.1).powi(7), n2i(66206262.19008108, 66206262.19008109));
    assert_eq2!(n2i(-7451.145, -7451.145).powi(7), n2i(-1.2751494979579603e+27, -1.27514949795796e+27));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(7), n2i(1.7976931348623157e+308, f64::INFINITY));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(7), n2i(f64::NEG_INFINITY, -1.7976931348623157e+308));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(7), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(7), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(7), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(7), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(-324.3, 2.5).powi(7), n2i(-3.77249472089645e+17, 610.3515625));
    assert_eq2!(n2i(0.01, 2.33).powi(7), n2i(1e-14, 372.8133428371959));
    assert_eq2!(n2i(-1.9, -0.33).powi(7), n2i(-89.38717389999998, -0.0004261844297700001));
    assert_eq2!(I::EMPTY.powi(-2), I::EMPTY);
    assert_eq2!(I::ENTIRE.powi(-2), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(0.0, 0.0).powi(-2), I::EMPTY);
    assert_eq2!(n2i(-0.0, -0.0).powi(-2), I::EMPTY);
    assert_eq2!(n2i(13.1, 13.1).powi(-2), n2i(0.005827166249053085, 0.005827166249053086));
    assert_eq2!(n2i(-7451.145, -7451.145).powi(-2), n2i(1.8011669533771807e-08, 1.801166953377181e-08));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(-2), n2i(0.0, 5e-324));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(-2), n2i(0.0, 5e-324));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(-2), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(-2), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(-2), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(-2), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-324.3, 2.5).powi(-2), n2i(9.508370646556842e-06, f64::INFINITY));
    assert_eq2!(n2i(0.01, 2.33).powi(-2), n2i(0.18419937740610434, 10000.0));
    assert_eq2!(n2i(-1.9, -0.33).powi(-2), n2i(0.2770083102493075, 9.182736455463727));
    assert_eq2!(I::EMPTY.powi(-8), I::EMPTY);
    assert_eq2!(I::ENTIRE.powi(-8), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(0.0, 0.0).powi(-8), I::EMPTY);
    assert_eq2!(n2i(-0.0, -0.0).powi(-8), I::EMPTY);
    assert_eq2!(n2i(13.1, 13.1).powi(-8), n2i(1.1530008693653744e-09, 1.1530008693653746e-09));
    assert_eq2!(n2i(-7451.145, -7451.145).powi(-8), n2i(1.0524849172833286e-31, 1.0524849172833288e-31));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(-8), n2i(0.0, 5e-324));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(-8), n2i(0.0, 5e-324));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(-8), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(-8), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(-8), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(-8), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-324.3, 2.5).powi(-8), n2i(8.173807596331488e-21, f64::INFINITY));
    assert_eq2!(n2i(0.01, 2.33).powi(-8), n2i(0.0011512049061603571, 1e+16));
    assert_eq2!(n2i(-1.9, -0.33).powi(-8), n2i(0.005888045974722156, 7110.309102419345));
    assert_eq2!(I::EMPTY.powi(-1), I::EMPTY);
    assert_eq2!(I::ENTIRE.powi(-1), I::ENTIRE);
    assert_eq2!(n2i(0.0, 0.0).powi(-1), I::EMPTY);
    assert_eq2!(n2i(-0.0, -0.0).powi(-1), I::EMPTY);
    assert_eq2!(n2i(13.1, 13.1).powi(-1), n2i(0.07633587786259541, 0.07633587786259542));
    assert_eq2!(n2i(-7451.145, -7451.145).powi(-1), n2i(-0.00013420756138821617, -0.00013420756138821614));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(-1), n2i(5.562684646268003e-309, 5.56268464626801e-309));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(-1), n2i(-5.56268464626801e-309, -5.562684646268003e-309));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(-1), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(-1), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(-1), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(-1), n2i(f64::NEG_INFINITY, 0.0));
    ...
    assert_eq2!(n2i(-1.9, -0.33).powi(-1), n2i(-3.0303030303030303, -0.5263157894736842));
    assert_eq2!(I::EMPTY.powi(-3), I::EMPTY);
    assert_eq2!(I::ENTIRE.powi(-3), I::ENTIRE);
    assert_eq2!(n2i(0.0, 0.0).powi(-3), I::EMPTY);
    assert_eq2!(n2i(-0.0, -0.0).powi(-3), I::EMPTY);
    assert_eq2!(n2i(13.1, 13.1).powi(-3), n2i(0.0004448218510727546, 0.00044482185107275467));
    assert_eq2!(n2i(-7451.145, -7451.145).powi(-3), n2i(-2.4173022446579435e-12, -2.417302244657943e-12));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(-3), n2i(0.0, 5e-324));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(-3), n2i(-5e-324, -0.0));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(-3), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(-3), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(-3), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(-3), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(-324.3, 2.5).powi(-3), I::ENTIRE);
    assert_eq2!(n2i(0.01, 2.33).powi(-3), n2i(0.07905552678373577, 1000000.0));
    assert_eq2!(n2i(-1.9, -0.33).powi(-3), n2i(-27.82647410746584, -0.14579384749963553));
    assert_eq2!(I::EMPTY.powi(-7), I::EMPTY);
    assert_eq2!(I::ENTIRE.powi(-7), I::ENTIRE);
    assert_eq2!(n2i(0.0, 0.0).powi(-7), I::EMPTY);
    assert_eq2!(n2i(-0.0, -0.0).powi(-7), I::EMPTY);
    assert_eq2!(n2i(13.1, 13.1).powi(-7), n2i(1.5104311388686403e-08, 1.5104311388686407e-08));
    assert_eq2!(n2i(-7451.145, -7451.145).powi(-7), n2i(-7.842217728991088e-28, -7.842217728991087e-28));
    assert_eq2!(n2i(1.7976931348623157e+308, 1.7976931348623157e+308).powi(-7), n2i(0.0, 5e-324));
    assert_eq2!(n2i(-1.7976931348623157e+308, -1.7976931348623157e+308).powi(-7), n2i(-5e-324, -0.0));
    assert_eq2!(n2i(0.0, f64::INFINITY).powi(-7), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(-0.0, f64::INFINITY).powi(-7), n2i(0.0, f64::INFINITY));
    assert_eq2!(n2i(f64::NEG_INFINITY, 0.0).powi(-7), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(f64::NEG_INFINITY, -0.0).powi(-7), n2i(f64::NEG_INFINITY, 0.0));
    assert_eq2!(n2i(-324.3, 2.5).powi(-7), I::ENTIRE);
    assert_eq2!(n2i(0.01, 2.33).powi(-7), n2i(0.002682307431353632, 100000000000000.0));
    assert_eq2!(n2i(-1.9, -0.33).powi(-7), n2i(-2346.402003798384, -0.011187287351972096));
}
...
fn minimal_pown_dec_test() {
    ...
    assert_eq2!(nd2di(f64::NEG_INFINITY, 15.0, D::Dac).powi(0), nd2di(1.0, 1.0, D::Dac));
    assert_eq2!(nd2di(-3.0, 5.0, D::Def).powi(2), nd2di(0.0, 25.0, D::Def));
    assert_eq2!(nd2di(-1.7976931348623157e+308, 2.0, D::Com).powi(2), nd2di(0.0, f64::INFINITY, D::Dac));
    assert_eq2!(nd2di(-3.0, 5.0, D::Dac).powi(3), nd2di(-27.0, 125.0, D::Dac));
    assert_eq2!(nd2di(-1.7976931348623157e+308, 2.0, D::Com).powi(3), nd2di(f64::NEG_INFINITY, 8.0, D::Dac));
    assert_eq2!(nd2di(3.0, 5.0, D::Com).powi(-2), nd2di(0.039999999999999994, 0.11111111111111112, D::Com));
    assert_eq2!(nd2di(-5.0, -3.0, D::Def).powi(-2), nd2di(0.039999999999999994, 0.11111111111111112, D::Def));
    assert_eq2!(nd2di(-5.0, 3.0, D::Com).powi(-2), nd2di(0.039999999999999994, f64::INFINITY, D::Trv));
    assert_eq2!(nd2di(3.0, 5.0, D::Dac).powi(-3), nd2di(0.007999999999999998, 0.03703703703703704, D::Dac));
    assert_eq2!(nd2di(-3.0, 5.0, D::Com).powi(-3), nd2di(f64::NEG_INFINITY, f64::INFINITY, D::Trv));
}
