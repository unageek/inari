...
fn minimal_overlap_test() {
    ...
    assert_eq2!(n2i(1.0, 2.0).overlap(n2i(1.0, 2.0)), O::Equal);
    assert_eq2!(n2i(1.0, 1.0).overlap(n2i(1.0, 1.0)), O::Equal);
    assert_eq2!(n2i(f64::NEG_INFINITY, 1.0).overlap(n2i(f64::NEG_INFINITY, 1.0)), O::Equal);
    assert_eq2!(I::ENTIRE.overlap(I::ENTIRE), O::Equal);
...
fn minimal_overlap_dec_test() {
    assert_eq2!(DI::EMPTY.overlap(DI::EMPTY), O::BothEmpty);
    assert_eq2!(DI::EMPTY.overlap(nd2di(1.0, 2.0, D::Com)), O::FirstEmpty);
    assert_eq2!(nd2di(1.0, 2.0, D::Def).overlap(DI::EMPTY), O::SecondEmpty);
    assert_eq2!(nd2di(2.0, 2.0, D::Def).overlap(nd2di(3.0, 4.0, D::Def)), O::Before);
    assert_eq2!(nd2di(1.0, 2.0, D::Dac).overlap(nd2di(3.0, 4.0, D::Com)), O::Before);
    assert_eq2!(nd2di(1.0, 2.0, D::Com).overlap(nd2di(3.0, 3.0, D::Trv)), O::Before);
    assert_eq2!(nd2di(2.0, 2.0, D::Trv).overlap(nd2di(3.0, 3.0, D::Def)), O::Before);
    assert_eq2!(nd2di(1.0, 2.0, D::Def).overlap(nd2di(2.0, 3.0, D::Def)), O::Meets);
    assert_eq2!(nd2di(1.0, 2.0, D::Dac).overlap(nd2di(1.5, 2.5, D::Def)), O::Overlaps);
    assert_eq2!(nd2di(1.0, 2.0, D::Def).overlap(nd2di(1.0, 3.0, D::Com)), O::Starts);
    assert_eq2!(nd2di(1.0, 1.0, D::Trv).overlap(nd2di(1.0, 3.0, D::Def)), O::Starts);
    assert_eq2!(nd2di(1.0, 2.0, D::Def).overlap(nd2di(0.0, 3.0, D::Dac)), O::ContainedBy);
    assert_eq2!(nd2di(2.0, 2.0, D::Trv).overlap(nd2di(0.0, 3.0, D::Def)), O::ContainedBy);
    assert_eq2!(nd2di(1.0, 2.0, D::Trv).overlap(nd2di(0.0, 2.0, D::Com)), O::Finishes);
    assert_eq2!(nd2di(2.0, 2.0, D::Def).overlap(nd2di(0.0, 2.0, D::Dac)), O::Finishes);
    assert_eq2!(nd2di(1.0, 2.0, D::Def).overlap(nd2di(1.0, 2.0, D::Def)), O::Equal);
    assert_eq2!(nd2di(1.0, 1.0, D::Dac).overlap(nd2di(1.0, 1.0, D::Dac)), O::Equal);
    assert_eq2!(nd2di(3.0, 4.0, D::Trv).overlap(nd2di(2.0, 2.0, D::Trv)), O::After);
    assert_eq2!(nd2di(3.0, 4.0, D::Def).overlap(nd2di(1.0, 2.0, D::Def)), O::After);
    assert_eq2!(nd2di(3.0, 3.0, D::Com).overlap(nd2di(1.0, 2.0, D::Dac)), O::After);
    assert_eq2!(nd2di(3.0, 3.0, D::Def).overlap(nd2di(2.0, 2.0, D::Trv)), O::After);
    assert_eq2!(nd2di(2.0, 3.0, D::Def).overlap(nd2di(1.0, 2.0, D::Trv)), O::MetBy);
    assert_eq2!(nd2di(1.5, 2.5, D::Com).overlap(nd2di(1.0, 2.0, D::Com)), O::OverlappedBy);
    assert_eq2!(nd2di(1.0, 3.0, D::Dac).overlap(nd2di(1.0, 2.0, D::Def)), O::StartedBy);
    assert_eq2!(nd2di(1.0, 3.0, D::Com).overlap(nd2di(1.0, 1.0, D::Dac)), O::StartedBy);
    assert_eq2!(nd2di(0.0, 3.0, D::Com).overlap(nd2di(1.0, 2.0, D::Dac)), O::Contains);
    assert_eq2!(nd2di(0.0, 3.0, D::Com).overlap(nd2di(2.0, 2.0, D::Def)), O::Contains);
    assert_eq2!(nd2di(0.0, 2.0, D::Def).overlap(nd2di(1.0, 2.0, D::Trv)), O::FinishedBy);
    assert_eq2!(nd2di(0.0, 2.0, D::Dac).overlap(nd2di(2.0, 2.0, D::Def)), O::FinishedBy);
}
